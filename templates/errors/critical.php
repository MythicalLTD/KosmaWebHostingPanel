...
<head>
    ...
    <title>KosmaPanel - Critical Error</title>
    ...
    <style>body{overflow:hidden;font-family:'Segoe UI',Tahoma,Geneva,Verdana,sans-serif;background-image:url(https://wallpaperaccess.com/full/8642981.jpg);background-color:#34495e;background-blend-mode:overlay;background-size:cover;background-position:center;color:#fff}body.loading{overflow:hidden}.container{display:flex;justify-content:center;align-items:center;height:100vh}.card{max-width:800px;border:none;border-radius:20px;box-shadow:0 2px 6px rgba(0,0,0,.3);overflow:hidden}.card-header{background-color:#e74c3c;border-radius:20px 20px 0 0;font-weight:700;display:flex;align-items:center;border-bottom:none}.card-header::before{content:"⚠️";font-size:28px;margin-right:12px}.card-body{background-color:#222831;overflow-y:auto;max-height:500px}.error-message{color:#ff6363;font-size:24px;line-height:1.5;font-weight:700;margin-top:0}.code-box{background-color:#2c3e50;border-radius:8px;padding:20px;margin-top:30px;max-height:250px;overflow-y:auto}.cline{font-family:"Courier New",Courier,monospace;color:#fff;margin:0}.error-text{margin-top:30px;font-size:18px;line-height:1.5}.error-text a{color:#e74c3c;font-weight:700;text-decoration:none}.error-text a:hover{text-decoration:underline}#particles-js{position:fixed;top:0;left:0;width:100%;height:100%;z-index:-1}.preloader{position:fixed;top:0;left:0;width:100%;height:100%;z-index:9999;opacity:1;background:#222831;display:flex;flex-direction:column;justify-content:center;align-items:center;transition:opacity 2s ease-in-out}.loader{border:5px solid #f3f3f3;border-top:5px solid #3498db;border-radius:50%;width:50px;height:50px;animation:spin 2s linear infinite}.loading-text{color:#fff;font-size:24px;margin-top:20px}@keyframes spin{0%{transform:rotate(0deg)}100%{transform:rotate(360deg)}}@keyframes backgroundTransition{0%{background:#000}25%{background:#111}50%{background:#000}100%{background:#111}}@keyframes fadeOut{0%{opacity:1}100%{opacity:0;display:none}}</style>
</head>
<body class="loading">
    <div class="preloader">
